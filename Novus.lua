...
if game.PlaceId == 3956818381 then
    ...
    nlMisc:addButton("Collect Chests", function()
        ...
        wait(3.5)
        game:GetService("Workspace").ultraninjitsuChest["circleInner"].CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
        wait(3.5)
        ...
        wait(3.5)
        game:GetService("Workspace").chaoslegendsChest["circleInner"].CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
        wait(3.5)
        game:GetService("Workspace").wonderChest["circleInner"].CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
        game:GetService("Workspace").midnightShadowChest["circleInner"].CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
        ...
        game:GetService("Workspace").ultraninjitsuChest["circleInner"].CFrame = game.Workspace.Part.CFrame
        game:GetService("Workspace").goldenzenChest["circleInner"].CFrame = game.Workspace.Part.CFrame
        game:GetService("Workspace").skystormmasterscChest["circleInner"].CFrame = game.Workspace.Part.CFrame
        game:GetService("Workspace").chaoslegendsChest["circleInner"].CFrame = game.Workspace.Part.CFrame
